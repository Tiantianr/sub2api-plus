export default {
  promptAudit: {
    ...
    events: {
      title: 'Audit events', description: 'Review events by identity, IP, route, risk, hash, and time; the detail view shows the complete audited content.', decision: 'Decision', risk: 'Risk level', failureReason: 'Failure reason', failureReasonFallback: 'Audit failure', failureReasons: { prompt_guard_unavailable: 'Guard temporarily unavailable', prompt_guard_invalid_response: 'Guard returned an invalid response', payload_missing: 'Audit payload unavailable', config_version_changed: 'Audit configuration changed', no_enabled_endpoint: 'No Guard node is enabled' }, endpoint: 'Endpoint', clientIp: 'Client IP', filterByIp: 'Filter by IP {ip}', groupId: 'Group ID', userId: 'User ID', filterByUserId: 'Filter by user ID {id}', apiKeyId: 'API Key ID', keyword: 'Keyword',
      ...
      passRetentionNotice: 'Every Pass appears as a lightweight event; full evidence is retained for {count} users. Flag and Critical findings always retain full evidence.', openConfiguration: 'Open configuration',
      ...
      score: 'Score',
      categories: 'Categories', model: 'Model', stage: 'Request stage', executionMode: 'Execution mode', promptSize: 'Audited size', promptSizeValue: '{chars} characters · {messages} messages', contentStatus: 'Content status', contentComplete: 'Complete', contentTruncated: 'Truncated', contentLightweight: 'Lightweight summary', noRisks: 'No derived risk summaries for this event.',
