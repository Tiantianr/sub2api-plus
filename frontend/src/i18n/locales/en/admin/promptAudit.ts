export default {
  promptAudit: {
    ...
    events: {
      title: 'Audit events', description: 'Review events by identity, IP, route, risk, hash, and time. Each event can analyze its own user session.', decision: 'Decision', risk: 'Risk level', failureReason: 'Failure reason', failureReasonFallback: 'Audit failure', failureReasons: { prompt_guard_unavailable: 'Guard temporarily unavailable', prompt_guard_invalid_response: 'Guard returned an invalid response', payload_missing: 'Audit payload unavailable', config_version_changed: 'Audit configuration changed', no_enabled_endpoint: 'No Guard node is enabled' }, endpoint: 'Endpoint', clientIp: 'Client IP', filterByIp: 'Filter by IP {ip}', groupId: 'Group ID', userId: 'User ID', filterByUserId: 'Filter by user ID {id}', apiKeyId: 'API Key ID', keyword: 'Keyword',
