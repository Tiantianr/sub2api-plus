export default {
    ...
    riskControl: {
      ...
      textApiModeDesc: {
        auto: 'When Prompt Guard covers the request, text moderation becomes shadow-only; otherwise it still blocks. Images always follow the global mode.',
        blocking: 'The Moderation API judges both text and images under the global mode, duplicating Prompt Guard text review.',
        observe: 'Text API results are comparison-only: no blocking, risk hash, notification, or ban. Images still follow the global mode.',
