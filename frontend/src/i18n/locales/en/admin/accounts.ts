export default {
    accounts: {
      ...
      groupCoverageWarning: '{count} active group(s) currently have no schedulable account',
      groupCoverageUnbound: 'No linked accounts',
      groupCoverageUnavailable: 'No available accounts',
      filterByGroup: 'Filter accounts in group "{name}"',
