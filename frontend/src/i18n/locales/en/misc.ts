export default {
  ...
  payment: {
    ...
    tabTopUp: 'Recharge Balance',
    tabSubscribe: 'Subscription Plans',
    currentUser: 'Current User',
    selectSubscriptionPlan: 'Choose the subscription plan that fits you',
    subscriptionSubtitle: 'Unlock more quota and privileges, enjoy a more stable service experience',
    rateQuotaHint: '1 CNY = {usd} USD Quota',
    confirmPay: 'Confirm Payment',
    footerNotice: 'Recharge 1:1 (1 CNY = 1 USD quota). CNY is the payment amount, USD is usage quota. Minimum recharge is 1 CNY (non-subscription). Subscribing to the same plan renews validity without stacking quota. Ensure the amount is correct! Invoicing is temporarily unsupported. Contact support for any payment issues.',
