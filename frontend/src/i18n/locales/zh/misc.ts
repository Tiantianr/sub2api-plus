export default {
  ...
  payment: {
    ...
    tabSubscribe: '订阅套餐',
    currentUser: '当前用户',
    selectSubscriptionPlan: '选择适合您的订阅套餐',
    subscriptionSubtitle: '解锁更多额度与特权，享受更稳定的服务体验',
    rateQuotaHint: '1 CNY = {usd} USD 额度',
    confirmPay: '确认支付',
    footerNotice: '充值1:1 (充值1CNY，兑换1USD)，CNY为实际充值数值，USD为使用额度。充值最低金额 1 CNY (非订阅分组)。订阅相同套餐不可叠加额度，相同套餐为续期。 注意输入金额不能出现错误! 暂时不支持开票业务! 若有支付问题，请联系客服。',
    noPlans: '暂无可用订阅套餐',
