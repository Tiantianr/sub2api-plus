export default {
    ...
    riskControl: {
      ...
      textApiModeDesc: {
        auto: 'Prompt Guard 覆盖当前请求时，文本 API 仅影子记录；未覆盖时仍同步裁决。图片始终按全局模式审核。',
        blocking: '文本和图片都由 Moderation API 按全局模式裁决，会与 Prompt Guard 重复审核文本。',
        observe: '文本 API 只记录对比结果，不拦截、不写风险 hash、不触发通知或封禁；图片仍按全局模式裁决。',
