export default {
  promptAudit: {
    ...
    events: {
      ...
      promptFullHint: '当前展示 Guard 实际送检内容；完整上下文下载还包含被 Guard 选段排除的 canonical 内容，请按敏感数据妥善处理。',
      ...
      evidence: '脱敏证据',
      score: '分数',
      categories: '分类', model: '模型', stage: '请求阶段', executionMode: '执行模式', promptSize: '送检规模', promptSizeValue: '{chars} 字符 · {messages} 条消息', contentStatus: '内容状态', contentComplete: '完整', contentTruncated: '已截断', contentLightweight: '轻量摘要', noRisks: '本事件没有派生风险摘要。',
