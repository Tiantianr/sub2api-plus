...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Tiantianr/sub2api-plus/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/Tiantianr/sub2api-plus/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Tiantianr/sub2api-plus/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/Tiantianr/sub2api-plus/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
.settings-tab-active::after {
  ...
  content: "";
  background: linear-gradient(90deg, #3c80e6, #2563eb);
}
