...
- [x] 4.1 Cover default, selected-user, risk-event, corruption, CAS,
  invalidation, and receipt-isolation behavior.
- [x] 4.2 Cover preview estimates, confirmation binding, high-water deletion,
  and context cascade behavior.
- [x] 4.3 Cover user selection, missing users, Pass-only filters, and mandatory
  preview in frontend tests.
- [x] 4.4 Update security coverage documentation and run focused backend,
  frontend, documentation, and strict OpenSpec checks.
