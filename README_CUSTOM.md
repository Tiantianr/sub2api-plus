...
```text
当前 Plus 基线：v0.1.183+custom.001
个人已发布版本：v0.1.183+custom.901
当前候选版本：v0.1.183+custom.902
同一官方基线的下一版本：v0.1.183+custom.903
```
...
| --- | --- | --- |
| `v0.1.183+custom.902` | `v0.1.183+custom.001` | 计划发布 |
| `v0.1.183+custom.901` | `v0.1.183+custom.001` | 已发布 |
| `v0.1.178+custom.904` | `v0.1.178+custom.005` | 已发布 |
| `v0.1.178+custom.903` | `v0.1.178+custom.005` | 已发布 |
...
`v0.1.183+custom.901` 的 Release 与公开镜像验证。新候选版本在完整发布验证前，界面不会有对应资产。
ID3 生产仍运行 Plus `v0.1.178+custom.005`；生产切换前仍不得使用“升级”或“版本回退”。
