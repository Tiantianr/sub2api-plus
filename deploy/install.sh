...
# Sub2API Plus 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Tiantianr/sub2api-plus/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Tiantianr/sub2api-plus"
...
Documentation=https://github.com/Tiantianr/sub2api-plus
