...
```bash
curl -sSL https://raw.githubusercontent.com/Tiantianr/sub2api-plus/main/deploy/install.sh | sudo bash -s -- install --version 'v0.1.183+custom.915'
```
...
```bash
sudo ./install.sh install --version 'v0.1.183+custom.915'
```
