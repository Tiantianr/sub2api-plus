...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			openaioauthaccountaccesspolicy.Table: openaioauthaccountaccesspolicy.ValidColumn,
			openaioauthaccountusergrant.Table:    openaioauthaccountusergrant.ValidColumn,
