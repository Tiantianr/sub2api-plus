...
type UserEdges struct {
	...
	// OpenaiOauthAccountGrants holds the value of the openai_oauth_account_grants edge.
	OpenaiOauthAccountGrants []*OpenAIOAuthAccountUserGrant `json:"openai_oauth_account_grants,omitempty"`
...
// OpenaiOauthAccountGrantsOrErr returns the OpenaiOauthAccountGrants value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) OpenaiOauthAccountGrantsOrErr() ([]*OpenAIOAuthAccountUserGrant, error) {
	if e.loadedTypes[13] {
		return e.OpenaiOauthAccountGrants, nil
	}
	return nil, &NotLoadedError{edge: "openai_oauth_account_grants"}
}
...
// QueryOpenaiOauthAccountGrants queries the "openai_oauth_account_grants" edge of the User entity.
func (_m *User) QueryOpenaiOauthAccountGrants() *OpenAIOAuthAccountUserGrantQuery {
	return NewUserClient(_m.config).QueryOpenaiOauthAccountGrants(_m)
}
