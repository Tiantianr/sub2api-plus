...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIOAuthUserAccessRepository := repository.NewOpenAIOAuthUserAccessRepository(db, accountRepository, schedulerCache)
	openAIOAuthUserAccessService := service.NewOpenAIOAuthUserAccessService(openAIOAuthUserAccessRepository)
	openAIOAuthUserAccessHandler := admin.NewOpenAIOAuthUserAccessHandler(openAIOAuthUserAccessService)
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, proxyRepository, apiKeyAuthCacheInvalidator, emailService, apiKeyRepository, secretEncryptor)
	...
	atomicMetrics := providePromptAuditMetrics(opsAlertEvaluatorService)
