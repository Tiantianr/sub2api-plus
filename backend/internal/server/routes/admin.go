...
func registerPromptAuditRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	promptAudit := admin.Group("/prompt-audit")
	{
		...
		promptAudit.GET("/pass-retention", h.Admin.PromptAudit.GetPassRetention)
		promptAudit.PUT("/pass-retention", h.Admin.PromptAudit.UpdatePassRetention)
		...
		promptAudit.POST("/events/:id/analyze", h.Admin.PromptAudit.AnalyzeEvent)
		promptAudit.GET("/events/:id/context", h.Admin.PromptAudit.DownloadEventContext)
