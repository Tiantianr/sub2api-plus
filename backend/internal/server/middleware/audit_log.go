...
var auditExtraAllowedKeys = map[string]struct{}{
	...
	"event_id": {}, "user_id": {}, "record_count": {}, "requested_count": {}, "deleted_events": {}, "deleted_jobs": {},
...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/prompt-audit/events/:id/analyze":           "admin.prompt_audit.event.analyze",
